...
import { createSubject, deleteSubjectById, getSubjectById, getSubjectList, updateSubjectById ,fakeSubject} from './subject.api';
...
subjectRoute.get('/subjects/dump', fakeSubject);
